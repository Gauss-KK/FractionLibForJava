// Filename: TestMyFractionLib.java
//
// 
// Compile: javac -cp myfraction.jar TestMyFractionLib.java
// Execute: java -cp ".;myfraction.jar" TestMyFractionLib
//   Or
// Execute: java -cp .;myfraction.jar TestMyFractionLib
//
//
// Date: 2022.07.25 ~ 2022.07.27      Bersiom 0.0.2   Create myfraction.jar and use it
...
public class TestMyFractionLib {
    public static void main(String[] args) {
        ...
        System.out.printf("inf = %s\n", inf);
        System.out.printf("inf.isInfinity() ?  %s\n", inf.isInfinity() ? "Yes" : "No");
        System.out.printf("inf.isPositiveInfinity() ?  %s\n", inf.isPositiveInfinity() ? "Yes" : "No");
        System.out.printf("inf.isNegativeInfinity() ?  %s\n", inf.isNegativeInfinity() ? "Yes" : "No");
        ...
        System.out.printf("minf = %s\n", minf);
        System.out.printf("minf.isInfinity() ?  %s\n", minf.isInfinity() ? "Yes" : "No");
        System.out.printf("minf.isPositiveInfinity() ?  %s\n", minf.isPositiveInfinity() ? "Yes" : "No");
        System.out.printf("m inf.isNegativeInfinity() ?  %s\n", minf.isNegativeInfinity() ? "Yes" : "No");
...
;
        ...
        System.out.printf("1/inf == zero ?  %s\n", inf.invert().equalTo(zero));
